export const chooseAnimalAtRandom = () => {
  ...
  //console.log( allAnimals[indexAtRandom],animalList[allAnimals[indexAtRandom]] )
  return {
    animal: allAnimals[indexAtRandom],
    picture: animalList[allAnimals[indexAtRandom]],
  };
};
